...
QE(E,Eg,lx,k,T_detector,lambda_vector,R)
...
IXV(e_mob,tau_e,me,mh,na,V,b,alfa,B,E,Eg,lx,T_detector,lambda_vector,epsilon,sigma_photon,T_source,T_bkg,A_source,A_bkg,h,c,k,A_det,q,etha2)

Responsivity(lambda_vector,q,E,Eg,lx,k,T_detector)

Detectivity(lambda_vector,q,E,Eg,lx,k,T_detector,epsilon,sigma_photon,T_source,T_bkg,A_source,A_bkg,h,c)

NEP(lambda_vector,q,E,Eg,lx,k,T_detector,epsilon,sigma_photon,T_source,T_bkg,A_source,A_bkg,h,c)